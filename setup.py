...
with open(resource('spifit', '__init__.py')) as version_file:
...
setup(
    name='spifit',
    version=VERSION,
    description='Package for spiral tracing and fitting',
    long_description=README,
    license='MIT',
    author='Valentin Christiaens',
    author_email='valentin.christiaens@uliege.be',
    url='https://github.com/VChristiaens/spifit',
